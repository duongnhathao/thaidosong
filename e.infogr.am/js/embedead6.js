(function(root) {
    ...
    InfogramEmbed.prototype = {
        ...
        load: function() {
            ...
            docEvents.scroll.options = {passive: true, capture: true};
        ...
        loadInfographic: function(elem, opts) {
            ...
            var url = protocol + '//' + location.host + '/' + opts.id + '?parent_url=' + encodeURIComponent(document.location.href) + '&src=embed' + type + '#async_embed';
