...
<!-- Mirrored from preview.colorlib.com/theme/startup2/about.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Dec 2020 14:18:57 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="row align-items-center justify-content-start">
                <div class="col-lg-12 col-md-12">
                    <div class="slider_text">
                        ...
                        <a class="boxed-btn3 wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".2s" href="#">Visit
                            Our Works</a>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="mision_info">
                    ...
                    <div class="single_mission">
                        <p>Professionally cultivate one-to-one Dynamically innovate resource-leveling customer service
                            for state of the art customer service. Objectively innovate empowered manufactured products
                            whereas parallel platforms service with robust ideas.</p>
                    </div>
                    <div class="single_mission">
