...
<head>
    ...
    <title>Liên hệ | Life Skills - Ba Chấm Team</title>
    <meta name="description" content="Liên hệ">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Life Skills: Liên hệ">
    <meta property="og:site_name" content="Life Skills: Liên hệ">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Life Skills: Liên hệ">
    <meta property="og:description"
          content="Cách thức liên lạc và địa chỉ của team Ba Chấm">
...
<!--                </form>-->
            ...
            <div class="col-lg-4">
                ...
                <div class="media contact-info">
                    ...
                    <div class="media-body">
                        <a href="mailto:duongnhathao001@gmail.com">duongnhathao001@gmail.com</a><br></p>
                    </div>
                </div>
            </div>
        </div>
